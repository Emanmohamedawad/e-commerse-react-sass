            ...
            <div className="row">
               ...
               >
                  ...
                  {/* <SwiperSlide>
                     ...
                     <img src={Prod1} className="imgpro w-100" alt="" />
                     <p className="px-2 des">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                     <div className="price d-flex justify-content-between align-items-center">
                        <div className="price px-2">
                        <h4>9,999 LE</h4>
                        <p className="d-inline">9,999 LE </p>
                        <span className="sale text-dark mx-2 border-2">50%</span>
                     </div>
                     <div>
                        <img src={Adidas} alt="" className="w-100"/>
                     </div>
                     ...
                     <p className="mt-3 mx-3">4.2 of 5</p>
                     </div>
                  ...
                  <SwiperSlide>
                     ...
                     <img src={Prod2} className="imgpro w-100" alt="" />
                     <p className="px-2 des">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                     <div className="price d-flex justify-content-between align-items-center">
                        <div className="price px-2">
                        <h4>9,999 LE</h4>
                  ...
                  <SwiperSlide>
                     ...
                     <img src={Prod3} className="imgpro w-100" alt=""/>
                     <p className="px-2 des">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                     <div className="price d-flex justify-content-between align-items-center">
                        <div className="price px-2">
                        <h4>9,999 LE</h4>
                  ...
                  <SwiperSlide>
                     ...
                     <img src={Prod4} className="imgpro w-100" alt=""/>
                     <p className="px-2 des">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                     <div className="price d-flex justify-content-between align-items-center">
                        <div className="price px-2">
                        <h4>9,999 LE</h4>
